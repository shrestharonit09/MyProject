...
const ContactMe = () => {
  ...
  return (
    <div className="flex flex-col gap-4 items-center pt-8">
      <h1 className="text-md md:text-xl lg:text-2xl bg-gradient-to-r from-purple-500 to-pink-500 font-semibold text-transparent bg-clip-text">If you have any query feel free to contact me</h1>
      <form
